...
public class HouseKeepingReport extends Activity {

	String item1[] = { "Proper Cleaning Required", "It Is On Height",
			"Flex Damaged", "Others" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnHKq1Y = (Spinner) findViewById(R.id.btnHKq1Y);
		btnHKq2Y = (Spinner) findViewById(R.id.btnHKq2Y);
		btnHKq3Y = (Spinner) findViewById(R.id.btnHKq3Y);
		btnHKq4Y = (Spinner) findViewById(R.id.btnHKq4Y);
		btnHKq5Y = (Spinner) findViewById(R.id.btnHKq5Y);
		btnHKq6Y = (Spinner) findViewById(R.id.btnHKq6Y);
		btnHKq7Y = (Spinner) findViewById(R.id.btnHKq7Y);
		btnHKq8Y = (Spinner) findViewById(R.id.btnHKq8Y);
		btnHKq9Y = (Spinner) findViewById(R.id.btnHKq9Y);
		btnHKq10Y = (Spinner) findViewById(R.id.btnHKq10Y);
		btnHKq11Y = (Spinner) findViewById(R.id.btnHKq11Y);
		btnHKq12Y = (Spinner) findViewById(R.id.btnHKq12Y);
		btnHKq13Y = (Spinner) findViewById(R.id.btnHKq13Y);
		btnHKq14Y = (Spinner) findViewById(R.id.btnHKq14Y);
		btnHKq15Y = (Spinner) findViewById(R.id.btnHKq15Y);
		btnHKq16Y = (Spinner) findViewById(R.id.btnHKq16Y);
		btnHKq17Y = (Spinner) findViewById(R.id.btnHKq17Y);
		btnHKq18Y = (Spinner) findViewById(R.id.btnHKq18Y);
		btnHKq19Y = (Spinner) findViewById(R.id.btnHKq19Y);
		btnHKq20Y = (Spinner) findViewById(R.id.btnHKq20Y);
		btnHKq21Y = (Spinner) findViewById(R.id.btnHKq21Y);

		btnHKq1N = (Spinner) findViewById(R.id.btnHKq1N);
		btnHKq2N = (Spinner) findViewById(R.id.btnHKq2N);
		btnHKq3N = (Spinner) findViewById(R.id.btnHKq3N);
		btnHKq4N = (Spinner) findViewById(R.id.btnHKq4N);
		btnHKq5N = (Spinner) findViewById(R.id.btnHKq5N);
		btnHKq6N = (Spinner) findViewById(R.id.btnHKq6N);
		btnHKq7N = (Spinner) findViewById(R.id.btnHKq7N);
		btnHKq8N = (Spinner) findViewById(R.id.btnHKq8N);
		btnHKq9N = (Spinner) findViewById(R.id.btnHKq9N);
		btnHKq10N = (Spinner) findViewById(R.id.btnHKq10N);
		btnHKq11N = (Spinner) findViewById(R.id.btnHKq11N);
		btnHKq12N = (Spinner) findViewById(R.id.btnHKq12N);
		btnHKq13N = (Spinner) findViewById(R.id.btnHKq13N);
		btnHKq14N = (Spinner) findViewById(R.id.btnHKq14N);
		btnHKq15N = (Spinner) findViewById(R.id.btnHKq15N);
		btnHKq16N = (Spinner) findViewById(R.id.btnHKq16N);
		btnHKq17N = (Spinner) findViewById(R.id.btnHKq17N);
		btnHKq18N = (Spinner) findViewById(R.id.btnHKq18N);
		btnHKq19N = (Spinner) findViewById(R.id.btnHKq19N);
		btnHKq20N = (Spinner) findViewById(R.id.btnHKq20N);
		btnHKq21N = (Spinner) findViewById(R.id.btnHKq21N);
		...
		btnhknext.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(HouseKeepingReport.this,HouseReportPhotoUpload.class);
				startActivity(i);
		...
		btnHKq3Y.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(HouseKeepingReport.this);
					...
					public void onClick(DialogInterface dialog, int which) {
						// TODO Auto-generated method stub
						 ...
						 if(selectedPosition == 2) {
							 AlertDialog.Builder alertDialog = new AlertDialog.Builder(HouseKeepingReport.this);
							 alertDialog.setTitle("Enter Remark:- ");
							
							 final EditText input = new EditText(HouseKeepingReport.this);  
